...
- (PSYSegmentControBaseView *)ninaBaseView {
    if (!_ninaBaseView) {
        _ninaBaseView = [[PSYSegmentControBaseView alloc] initWithFrame:self.bounds WithTopTabType:_ninaPagerStyles];
