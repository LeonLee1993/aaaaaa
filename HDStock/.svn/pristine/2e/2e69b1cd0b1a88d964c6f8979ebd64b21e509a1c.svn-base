...
@implementation HDHeadLineBigViewCellCell
...
- (void)setModel:(HDHeadLineModel *)model{
    ...
    [self.imageBig sd_setImageWithURL:[NSURL URLWithString:model.manypic0] placeholderImage:imageNamed(@"emptypic")];
