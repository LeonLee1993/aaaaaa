//
//  buiedProductListPresentViewController.m
//  HDStock
//
//  Created by liyancheng on 17/2/27.
...
@interface buiedProductListPresentViewController ()<UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate,fullPageFailLoadViewDelegate>

@end

@implementation buiedProductListPresentViewController{
