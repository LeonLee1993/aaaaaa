...
//
//
#define LXDefaultFirstWaveColor [UIColor whiteColor]
#define LXDefaultSecondWaveColor [UIColor whiteColor]

//#define LXDefaultFirstWaveColor [UIColor colorWithRed:255 green:255 blue:255 alpha:0.7]
//#define LXDefaultSecondWaveColor []
...
- (void)waveAnimation
{
    ...
    self.firstWaveLayer.opacity = 0.8;
    ...
    if (!self.isShowSingleWave) {
        ...
        self.secondWaveLayer.opacity = 0.3;
