...
- (void)drawDashLine {
    ...
    CGFloat x = self.stockScrollView.frame.origin.x + self.selectedPoint.x+YYStockScrollViewLeftGap;
    ...
    //绘制选中增幅
    NSString *text2 = [NSString stringWithFormat:@"%.2f",([self.selectedModel Price].floatValue - [self.selectedModel zrspj].floatValue)/[self.selectedModel zrspj].floatValue *100];
