...
@implementation HDHeadLineSingleViewCell
...
- (void)setModel:(HDHeadLineModel *)model{
    ...
    if (model.pic.length > 1) {
        
        [self.imageSingle sd_setImageWithURL:[NSURL URLWithString:model.pic]placeholderImage:imageNamed(@"emptypic_littleone")];
        
    }else{
    
        [self.imageSingle sd_setImageWithURL:[NSURL URLWithString:model.manypic0]placeholderImage:imageNamed(@"emptypic_littleone")];
