...
@interface HDLiveAnalystViewController ()

@end

@implementation HDLiveAnalystViewController
...
- (void) createWkWeb {
    ...
    self.wkWeb.backgroundColor = COLOR(purpleColor);;
