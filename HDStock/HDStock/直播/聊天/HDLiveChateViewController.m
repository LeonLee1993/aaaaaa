...
@interface HDLiveChateViewController ()<WKNavigationDelegate>{
...
@implementation HDLiveChateViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
//    self.view.backgroundColor = COLOR(cyanColor);
//    [self fitFrame];
    [self createWkWeb];
...
- (void) createWkWeb {
    ...
    [self.wkWeb loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://test.cdtzb.com/liveroom.php?type=chat"]]];
