...
- (instancetype)initWithFrame:(CGRect )frame segmentStyle:(ZJSegmentStyle *)segmentStyle delegate:(id<ZJScrollPageViewDelegate>)delegate titles:(NSArray *)titles selected:(NSInteger)selec titleDidClick:(TitleBtnOnClickBlock)titleDidClick {
...
- (UIButton *)extraBtn {
    ...
    if (!_extraBtn) {
        ...
        btn.backgroundColor = BGVIEW_COLOR;
        // 设置边缘的阴影效果
        btn.layer.shadowColor = BGVIEW_COLOR.CGColor;
